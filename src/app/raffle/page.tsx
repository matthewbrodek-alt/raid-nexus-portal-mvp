        ...
        <section className="mt-6 flex flex-1 justify-center">
          <div className="raid-ornate-panel w-full max-w-4xl overflow-hidden p-5 sm:p-7">
            ...
            <div className="relative mx-auto mt-7 max-w-[760px] overflow-hidden rounded-[28px] border border-relic/30 bg-[#030407] shadow-[0_28px_90px_rgba(0,0,0,0.55)]">
              ...
              <div
                className="group relative block aspect-[4/5] min-h-[500px] w-full overflow-hidden text-left sm:min-h-[580px]"
              ...
              >
                ...
                <video
                  ...
                  className="raffle-character-video pointer-events-none absolute left-1/2 top-[5%] z-[4] h-full w-full -translate-x-1/2 -translate-y-1/2 object-contain object-center opacity-100"
                  muted
                  playsInline
                  preload="auto"
