        ...
        <section className="mt-6 grid flex-1 gap-5 lg:grid-cols-[minmax(0,1fr)_380px]">
          <div className="raid-ornate-panel overflow-hidden p-5 sm:p-7">
            ...
            <div className="relative mx-auto mt-7 max-w-[760px] overflow-hidden rounded-[28px] border border-relic/30 bg-[#030407] shadow-[0_28px_90px_rgba(0,0,0,0.55)]">
              ...
              <div
                className="group relative block aspect-[16/10] min-h-[420px] w-full overflow-hidden text-left sm:min-h-[500px]"
              ...
              >
                ...
                <video
                  ...
                  className="raffle-character-video pointer-events-none absolute left-1/2 top-[54%] z-[4] h-[112%] w-[112%] -translate-x-1/2 -translate-y-1/2 object-cover object-center opacity-100"
                  muted
                  playsInline
                  preload="auto"
                ...
                <button
                  ...
                  className="absolute left-1/2 top-[28%] z-[8] h-[46%] w-[36%] -translate-x-1/2 rounded-full bg-transparent text-transparent outline-none disabled:cursor-default"
