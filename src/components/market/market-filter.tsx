...
export function MarketFilter() {
  return (
    <form className="grid gap-2 rounded-lg border border-white/10 bg-white/[0.04] p-2 sm:grid-cols-[120px_120px_120px_auto]">
      ...
      <button className="inline-flex items-center justify-center gap-2 rounded-md bg-relic px-4 py-2 text-sm font-semibold text-black transition hover:bg-[#8bbcff]">
        <Filter size={16} />
        Фильтр
      </button>
    </form>
